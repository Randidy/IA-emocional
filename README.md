...
Copie y pegue todo el siguiente bloque para instalar las librerías necesarias:

pip install streamlit pip install google-genai pip install google-generativeai pip install matplotlib pip install pandas pip install nltk pip install python-dotenv
